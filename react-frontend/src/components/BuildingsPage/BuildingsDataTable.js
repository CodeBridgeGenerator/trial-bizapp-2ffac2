...
<Column field="buildingname" header="Buildingname" body={pTemplate0} filter={selectedFilterFields.includes("buildingname")} hidden={selectedHideFields?.includes("buildingname")}  sortable style={{ minWidth: "8rem" }} />
